...
@health-color: #b52613; // more muted red (issue #3613)
//#BF0000;
...
/*	  [zoom < 16] {
		...
		glow/marker-opacity: 0.8;
		glow/marker-file: url('symbols/amenity/cafe.svg');
  ...
  [feature = 'highway_bus_stop'] {
    ...
    [zoom >= 18] {
      ...
      marker-width: 10;
	  [int_shelter = 'yes'] {
		marker-file: url('symbols/highway/bus_stop_covered.svg');
		marker-width: 14;
	  }
      marker-fill: @transportation-icon;
...
/* Any sized tower is useful orientation */
...
// Move this up (from Z17) as generally large
  ...
  [feature = 'amenity_marketplace'][zoom >= 16][way_pixels > @large-building-pixels],
  ...
  [feature = 'shop'][shop != 'mall'] {
    [zoom >= 17],
	[zoom >= 16][shop = 'garden_centre'], 
    [way_pixels > @large-building-pixels][zoom >= 15] {
      marker-clip: false;
      marker-fill: @shop-icon;
      marker-line-width: 0;

	[way_pixels <= @large-building-pixels][zoom < 18][shop != 'garden_centre'],
	[shop = 'other'] {
		marker-width: 6;
		[zoom < 18] { marker-width: 4; }
	}
  ...
  [feature = 'man_made_mineshaft'][zoom >= 15] {
	...
	[historic = 'yes'] {
		marker-file: url('symbols/disusedmine_compact.svg');
		marker-fill: #777;
...
//	[zoom < 16] { marker-width: 8 }
  ...
  [feature = 'amenity_parking_entrance'] {
     [zoom >= 15][int_access = 'yes'][feature = 'amenity_parking']["parking" != 'street_side']["parking" != 'lane'],
     [zoom >= 16][way_pixels > 750]["parking" != 'street_side']["parking" != 'lane'],
     [zoom >= 18] {
...
#text-point[zoom >= 10] {
  ...
  [feature = 'place_islet'][zoom >= 11][way_pixels > @large-building-pixels],
  ...
  [feature = 'place_locality'][zoom >= 15] {
    text-name: "[name]";
  ...
  [feature = 'amenity_place_of_worship'][zoom >= 16][way_pixels > @large-building-pixels],
  ...
  [feature = 'leisure_swimming_area'] {
    [zoom >= 14][way_pixels > @large-building-pixels][sport != 'equestrian'],
    [zoom >= 17] {
      text-name: "[name]";
      text-size: @standard-font-size;
      text-wrap-width: @standard-wrap-width;
  ...
  [feature = 'leisure_swimming_pool'][is_building = 'no'][indoor != 'yes'] {
    [zoom >= 14][way_pixels > @large-building-pixels],
    [zoom >= 17] {
      text-name: "[name]";
      text-size: @landcover-font-size;
      text-wrap-width: @landcover-wrap-width-size;
...
// scale labelling range by 2/3 reflecting tighter font size
  ...
  [feature = 'military_danger_area'][is_building = 'no'] {
    [zoom >= 9][way_pixels > @large-building-pixels],
    [zoom >= 17] {
      text-name: "[name]";
      text-size: @landcover-font-size;
      text-wrap-width: @landcover-wrap-width-size;
  ...
  [feature = 'landuse_garages'][is_building = 'no'] {
    [zoom >= 13][way_pixels > @large-building-pixels],
    [zoom >= 17] {
      text-name: "[name]";
      text-size: @landcover-font-size;
      text-wrap-width: @landcover-wrap-width-size;
...
// Use same logic for hospital as school
  ...
  [feature = 'amenity_nursing_home'],
  [feature = 'amenity_childcare'] {
	[zoom >= 16][way_pixels > @large-building-pixels],
    [zoom >= 17] {
      text-name: "[name]";
      text-size: @landcover-font-size;
      text-wrap-width: @landcover-wrap-width-size;
...
/*  [feature = 'shop_supermarket'],
  ...
  [feature = 'natural_sand'] {
    [zoom >= 8][way_pixels > @large-building-pixels][is_building = 'no'],
    [zoom >= 17][is_building = 'no'] {
      text-name: "[name]";
      text-size: @landcover-font-size;
      text-wrap-width: @landcover-wrap-width-size;
...
/* Currently only used for additional legend text */
#text-annotation {
  text-size: 7;
  text-name: "[name]";
  text-face-name: @standard-font;
